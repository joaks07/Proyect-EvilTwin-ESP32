...
1. Open **File > Preferences**.
   ...
   ![Arduino IDE Preferences menu](images/guide/image1.png)
...
2. In the **Additional Boards Manager URLs** field, add the following URL to enable ESP32 board support:
   ...
   ![Adding the ESP32 board manager URL](images/guide/image2.png)

3. Navigate to **Tools > Board > Boards Manager**.

   ![Opening the Boards Manager](images/guide/image4.png)

4. Search for and install **"esp32 by Espressif Systems"**.

   ![Installing the ESP32 board package](images/guide/image5.png)

5. Once installed, go to **Tools > Board** and select the appropriate board. In this case, select **ESP32 Dev Module**.

   ![Selecting the ESP32 Dev Module](images/guide/image6.png)
...
![Selecting the COM port](images/guide/image14.png)

You can also verify the connection through the **Device Manager**.

![Device Manager showing the ESP32](images/guide/image9.png)
...
![Verify button in the Arduino IDE](images/guide/image10.png)
...
![Upload button in the Arduino IDE](images/guide/image8.png)
...
2. When the authentication prompt appears, enter the following credentials:
   ...
   ![Authentication prompt for the admin panel](images/guide/image11.png)

3. The Captive Portal control panel should now be visible.

   ![Captive Portal admin panel](images/guide/image7.png)
...
1. In the Captive Portal admin panel (ESP32 #1), select the target network from the list. In this example, a personal home network is used to avoid any legal issues.
   ...
   ![Selecting a target network](images/guide/image12.png)
...
![Captive portal login page on the cloned network](images/guide/image13.png)
...
![Credential successfully captured on the Exfiltrator panel](images/guide/image3.jpg)
